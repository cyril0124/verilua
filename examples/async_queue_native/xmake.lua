...
-- Demonstrates cross-clock domain FIFO with NativeClock for both clock domains
-- Requires no_internal_clock since clocks are driven by NativeClock
...
target("test", function()
    ...
    -- Disable internal clock - we drive clocks using NativeClock
    ...
    -- Verilator requires TIMING_MODE for NativeClock
