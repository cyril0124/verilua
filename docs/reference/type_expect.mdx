...
- [CallableHDL](./data_structure/callable_hdl)：`expect_chdl()` 校验的核心对象。
- [Bundle](./data_structure/bundle)：`expect_bdl()` 对应的数据结构。
- [AliasBundle](./data_structure/alias_bundle)：`expect_abdl()` 的主要使用对象。
