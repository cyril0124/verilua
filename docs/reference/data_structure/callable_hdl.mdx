...
13. `set_imm_*` 立即赋值变体
    ...
    `set_imm_unchecked`、`set_imm_str`、`set_imm_hex_str`、`set_imm_bin_str`、`set_imm_dec_str`、`randomize_imm`、`set_bits_imm`、`set_bits_imm_hex_str`、`force_imm`、`release_imm`、`freeze_imm`
