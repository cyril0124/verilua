...
如果你想系统了解 `expect_chdl()`、`expect_abdl()`、`fake_chdl` 与位宽约束的完整语义，可以查看 [TypeExpect 参考文档](../reference/type_expect)。
:::
...
如果你需要单独查阅 `TypeExpect` 的接口与行为说明，可以继续阅读 [TypeExpect 参考文档](../reference/type_expect)。
