...
- `local texpect = require "TypeExpect"` 这里使用到了 Verilua 内置的 `TypeExpect` 模块，具体可以参考 [TypeExpect 模块](https://github.com/cyril0124/verilua/blob/master/src/lua/verilua/TypeExpect.lua)，主要用来检查参数的类型。
