...
class WrappedDriver {
  public:
    ...
    std::optional<bool> ignoreChiselTrivialSignals;
    ...
    WrappedDriver() {
        ...
        driver.cmdLine.add("--it,--ignore-chisel-trivial-signals", ignoreChiselTrivialSignals, "Ignore trivial signals");
