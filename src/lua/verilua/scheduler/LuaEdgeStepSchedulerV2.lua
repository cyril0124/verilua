...
---@field private _is_valid_task_id fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2, task_id: TaskID): boolean Checks if a task ID is valid
---@field private _is_valid_event_id fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2, event_id: EventID): boolean Checks if an event ID is valid
---@field private _alloc_task_id fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2): TaskID Allocates a new task ID
---@field private _alloc_event_id fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2): EventID Allocates a new event ID
---@field private _remove_task fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2, task_id: TaskID) Removes a task by ID
---@field private _register_callback fun(self: verilua.LuaScheduler_gen_LuaEdgeStepSchedulerV2, task_id: TaskID, callback_type: TaskCallbackType, integer_value: integer) Registers a callback for a task
