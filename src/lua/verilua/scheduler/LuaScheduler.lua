...
---@field register_event fun(self: verilua.scheduler.LuaScheduler, event_id: verilua.scheduler.EventID, task_id: verilua.scheduler.TaskID) Registers an event for a task
