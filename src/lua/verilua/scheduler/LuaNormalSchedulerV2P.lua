...
--[[luajit-pro, {ACC_TIME = 1, EDGE_STEP = 0, NORMAL = 1, SAFETY = 0, STEP = 0}]] 
...
---@field private _register_callback fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P, task_id: verilua.scheduler.TaskID, callback_type: verilua.scheduler.TaskCallbackType, integer_value: integer) Registers a callback for a task
