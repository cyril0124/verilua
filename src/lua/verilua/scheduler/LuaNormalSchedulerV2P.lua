...
--[[luajit-pro, {STEP = 0, EDGE_STEP = 0, NORMAL = 1, ACC_TIME = 1, SAFETY = 0}]] 
...
---@field private _is_coroutine_task fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P, task_id: TaskID): boolean Checks if a task is a coroutine task
---@field private _alloc_coroutine_task_id fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P): TaskID Allocates a new coroutine task ID
---@field private _remove_task fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P, task_id: TaskID) Removes a task by ID
---@field private _register_callback fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P, task_id: TaskID, callback_type: TaskCallbackType, str_value: string, integer_value: integer) Registers a callback for a task
...
---@field list_tasks fun(self: verilua.LuaScheduler_gen_LuaNormalSchedulerV2P) Lists all running tasks
