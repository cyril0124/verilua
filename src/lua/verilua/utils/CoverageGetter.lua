...
---@field enable_coverage fun(self: CoverageGetter, hier: string)
---@field disable_coverage fun(self: CoverageGetter, hier: string)
...
---@field show_coverage fun(self: CoverageGetter, hier: string, length?: number, recursive?: boolean)
---@field show_cond_coverage fun(self: CoverageGetter, hier: string, length?: number, recursive?: boolean)
...
---@field reset_coverage fun(self: CoverageGetter, hier: string)
...
function CoverageGetter:enable_coverage(hier)
    self.setDpiScope(hier)
    self.coverageCtrl(1)
end

---@param hier string Hierarchical path of the target module
function CoverageGetter:disable_coverage(hier)
    self.setDpiScope(hier)
    self.coverageCtrl(0)
end
...
function CoverageGetter:show_coverage(hier, length, recursive)
    local coverage = self:get_coverage(hier, recursive)
    print(f("[CoverageGetter] show_coverage: %s\n\t%s %.2f%%", hier, utils.get_progress_bar(coverage, length or 20),
        coverage * 100))
end
...
---@param length number? Length of the progress bar
---@param recursive boolean? Whether to calculate recursive coverage value
function CoverageGetter:show_cond_coverage(hier, length, recursive)
    local coverage = self:get_cond_coverage(hier, recursive)
...
---@param hier string Hierarchical path of the target module
function CoverageGetter:reset_coverage(hier)
    self.setDpiScope(hier)
    self.resetCoverage()
end
