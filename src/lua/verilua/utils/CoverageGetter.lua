...
--- `coverageCtrl`, `getCoverage` and `getCondCoverage`etc. are generated by `cov_exporter` where `cov_exporter`
...
if simulator == "verilator" then
    ...
    --- `coverageCtrl`, `getCoverage`, `getCondCoverage` etc. may be invisible in the symbol table(eliminated by the
...
elseif simulator == "vcs" or simulator == "xcelium" then
    ...
    showCoverageCount = C.showCoverageCount
else
...
---@field private cov_meta_info verilua.utils.CovExporterMetaInfo?
...
---@field read_cov_meta_info fun(self: verilua.utils.CoverageGetter, cov_meta_info_file?: string): verilua.utils.CoverageGetter
---
---@field setDpiScope fun(hier: string)
---@field enable_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, recursive?: boolean)
---@field disable_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, recursive?: boolean)
---@field get_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, recursive?: boolean): number
---@field get_cond_coverage fun(self: verilua.utils.CoverageGetter, hier: string, recursive?: boolean): number
---@field show_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, length?: number, recursive?: boolean)
---@field show_cond_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, length?: number, recursive?: boolean)
---@field get_coverage_count fun(self: verilua.utils.CoverageGetter, hier: string): number, number
---@field get_total_count fun(self: verilua.utils.CoverageGetter, hier: string): number
---@field get_total_bin_expr_count fun(self: verilua.utils.CoverageGetter, hier: string): number
---@field reset_coverage fun(self: verilua.utils.CoverageGetter, hier_or_module: string, recursive?: boolean)
---@field show_coverage_count fun(self: verilua.utils.CoverageGetter, hier_or_module: string)
---@field module_name_to_hiers fun(self: verilua.utils.CoverageGetter, module_name: string): string[]
local CoverageGetter = {
    ...
    showCoverageCount = showCoverageCount,
}
...
function CoverageGetter:enable_coverage(hier_or_module, recursive)
    if hier_or_module:find("%.") then
        ...
        ---@cast self.cov_meta_info verilua.utils.CovExporterMetaInfo
