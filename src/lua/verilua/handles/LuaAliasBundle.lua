...
---@overload fun(alias_signal_tbl: verilua.handles.AliasBundle.alias_signal_pair[], prefix: string, hierarchy: string, name: string, optional_signals: table<integer, string>?): verilua.handles.AliasBundle
---@field __type string
---@field prefix string
