...
local vpiml = {
    ...
    ---@type fun(id: verilua.scheduler.TaskID)
    ...
    ---@type fun(time: integer, id: verilua.scheduler.TaskID)
    ...
    ---@type fun(handle: verilua.handles.ComplexHandleRaw, u64_vec: table<integer, ffi.cdata*>, u64_vec_len: integer)
    vpiml_shuffled_range_u64 = C.vpiml_shuffled_range_u64,
    ---@type fun(handle: verilua.handles.ComplexHandleRaw, hex_str_vec: ffi.cdata*[][], hex_str_vec_len: integer)
