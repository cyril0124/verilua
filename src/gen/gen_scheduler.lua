...
---@field private _is_valid_task_id fun(self: verilua.LuaScheduler_gen, task_id: TaskID): boolean Checks if a task ID is valid
---@field private _is_valid_event_id fun(self: verilua.LuaScheduler_gen, event_id: EventID): boolean Checks if an event ID is valid
---@field private _alloc_task_id fun(self: verilua.LuaScheduler_gen): TaskID Allocates a new task ID
---@field private _alloc_event_id fun(self: verilua.LuaScheduler_gen): EventID Allocates a new event ID
...
---@field list_tasks fun(self: verilua.LuaScheduler_gen) List all running tasks
