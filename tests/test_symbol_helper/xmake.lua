...
target("test", function()
    ...
    on_run(function()
        ...
        find_and_check("[PASS] try_ffi_cast minimal form derives name + ptr type from decl")
        find_and_check("[PASS] try_ffi_cast minimal form errors on malformed decl")
        ...
        find_and_check("[PASS] try_ffi_cast minimal form succeeds via ffi.C fallback")
