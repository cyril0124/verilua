...
// -----------------------------------------
wire [7:0] count0; // output reg [7:0] count0
wire [7:0] count1; // output reg [7:0] count1
wire [VAL-1:0] count2; // output reg [VAL-1:0] count2
wire oo1; // output reg oo1
wire oo2; // output reg oo2
wire [7:0] oo3; // output reg [7:0] oo3
wire [7:0] oo4; // output reg [7:0] oo4
wire oo5; // output wire oo5
logic o; // output logic o
wire o3; // output reg o3
wire o4; // output wire o4
logic [7:0] o5; // output logic [7:0] o5
wire [7:0] o6; // output reg [7:0] o6
wire [7:0] o7; // output wire [7:0] o7
logic [7:0] o8 [3:0]; // output logic [7:0] o8 [3:0]
logic [VAL-1:0] o9 [3:0][VAL-1:0][VAL-1:0]; // output logic [VAL-1:0] o9 [3:0][VAL-1:0][VAL-1:0]
logic [7:0] o10 [0:9]; // output logic [7:0] o10 [0:9]
...
logic i; // input logic i
reg [7:0] i2 [3:0][3:0]; // input wire [7:0] i2 [3:0][3:0]
logic [VAL-1:0] i3 [3:0][VAL-1:0][VAL-1:0]; // input logic [VAL-1:0] i3 [3:0][VAL-1:0][VAL-1:0]
reg i4; // input bit i4
reg i5; // input wire i5
reg [7:0] i6; // input wire [7:0] i6
reg [VAL-1:0] i7 [3:0]; // input wire [VAL-1:0] i7 [3:0]
reg [3:0] io_axi_cfg_awregion; // input wire [3:0] io_axi_cfg_awregion
reg i10; // input bit i10
...
.LOGIC_PARAM(LOGIC_PARAM)
	...
	.count0                         (count0                        ) /* direction: output     dataType:  reg [7:0] */,
	.count1                         (count1                        ) /* direction: output     dataType:  reg [7:0] */,
	.count2                         (count2                        ) /* direction: output     dataType:  reg [VAL-1:0] */,
	.oo1                            (oo1                           ) /* direction: output     dataType:  reg */,
	.oo2                            (oo2                           ) /* direction: output     dataType:  reg */,
	.oo3                            (oo3                           ) /* direction: output     dataType:  reg [7:0] */,
	.oo4                            (oo4                           ) /* direction: output     dataType:  reg [7:0] */,
	.oo5                            (oo5                           ) /* direction: output     dataType: wire */,
	.o                              (o                             ) /* direction: output     dataType:  logic */,
	.o3                             (o3                            ) /* direction: output     dataType:  reg */,
	.o4                             (o4                            ) /* direction: output     dataType: wire */,
	.o5                             (o5                            ) /* direction: output     dataType:  logic [7:0] */,
	.o6                             (o6                            ) /* direction: output     dataType:  reg [7:0] */,
	.o7                             (o7                            ) /* direction: output     dataType: wire  [7:0] */,
	.o8                             (o8                            ) /* direction: output     dataType:  logic [7:0] */,
	.o9                             (o9                            ) /* direction: output     dataType:  logic [VAL-1:0] */,
	.o10                            (o10                           ) /* direction: output     dataType:  logic [7:0] */,
	...
	.i                              (i                             ) /* direction: input      dataType:  logic */,
	.i2                             (i2                            ) /* direction: input      dataType: wire  [7:0] */,
	.i3                             (i3                            ) /* direction: input      dataType:  logic [VAL-1:0] */,
	.i4                             (i4                            ) /* direction: input      dataType:  bit */,
	.i5                             (i5                            ) /* direction: input      dataType: wire */,
	.i6                             (i6                            ) /* direction: input      dataType: wire  [7:0] */,
	.i7                             (i7                            ) /* direction: input      dataType: wire  [VAL-1:0] */,
	.io_axi_cfg_awregion            (io_axi_cfg_awregion           ) /* direction: input      dataType: wire  [3:0] */,
	.i10                            (i10                           ) /* direction: input      dataType:  bit */,
